...
if __name__ == "__main__":
    ...
    s = int(input("Enter the number of Storage Houses: "))
    d = int(input("Enter the number of Showrooms: "))
    print()
    ...
    for i in range(0, s):
        rem = list()
        for j in range(0, d):
            k = int(input(f"Enter the cost of transportation for Storage-House {i+1} and Showroom {j+1} : "))
            rem.append(k)
        C.append(rem)
    print()
    ...
    S = list()
    for i in range(0, s):
        k = int(input(f"Enter the supply for Storage House- {i+1}: "))
        S.append(k)
    print()

    D = list()
    for i in range(0, d):
        k = int(input(f"Enter the demand for Showroom- {i+1}: "))
        D.append(k)
    print()
